...
class App(tk.Tk):
    ...
    def create_widgets(self, default_arguments_obj):
        ...
        lab = Label(self, text='INPUT FILES:')
        ...
        button_explore = Button(self, text='Browse', command=lambda:browseFiles(filein_ground))
        ...
        button_explore = Button(self, text='Browse', command=lambda:browseFiles(filein_vegetation))
        button_explore.grid(column=3, row=rowplacement, sticky=E, padx=padxval, pady=padyval)
        rowplacement += 1
        ...
        button_explore = Button(self, text='Browse', command=lambda:browseFiles(reclassfile))
        button_explore.grid(column=3, row=rowplacement, sticky=E, padx=padxval, pady=padyval)
        rowplacement += 1
        ...
        def getinput(self, default_arguments_obj):
            ...
            default_arguments_obj.reclassfile = filein_vegetation.get('1.0','end-1c').split('\n')[0]
            # model name
            ...
            if " " in model_nodes.get('1.0','end-1c'):
                ...
                print(default_arguments_obj.model_nodes)
